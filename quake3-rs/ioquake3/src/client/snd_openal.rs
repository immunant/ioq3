...
unsafe extern "C" fn S_AL_BufferFind(mut filename: *const libc::c_char) -> sfxHandle_t {
    ...
    // Not found in table?
    if sfx == -(1 as i32) {
        let mut ptr: *mut alSfx_t = std::ptr::null_mut();
...
unsafe extern "C" fn S_AL_SrcShutdown() {
    let mut i: i32 = 0;
    let mut curSource: *mut src_t = std::ptr::null_mut();
...
unsafe extern "C" fn S_AL_NewLoopMaster(mut rmSource: *mut src_t, mut iskilled: qboolean) {
    let mut index: i32 = 0;
    let mut curSource: *mut src_t = std::ptr::null_mut();
    let mut curSfx: *mut alSfx_t = std::ptr::null_mut();
...
unsafe extern "C" fn S_AL_MusicProcess(mut b: ALuint) {
    ...
    let mut l: i32 = 0;
    let mut format: ALuint = 0;
    let mut curstream: *mut snd_stream_t = std::ptr::null_mut();
    S_AL_ClearError(qfalse);
    if !intro_stream.is_null() {
...
pub unsafe extern "C" fn S_AL_Init(mut si: *mut soundInterface_t) -> qboolean {
    ...
    let mut inputdevice: *const libc::c_char = std::ptr::null();
    let mut i: i32 = 0;
    if si.is_null() {
        return qfalse;
    }
    ...
    if enumeration_ext as u32 != 0 || enumeration_all_ext as u32 != 0 {
        ...
        let mut devicelist: *const libc::c_char = std::ptr::null();
    ...
    ) == 0
    {
        ...
        let mut inputdevicenames: [libc::c_char; 16384] =
            *::std::mem::transmute::<&[u8; 16384],
                                     &mut [libc::c_char; 16384]>(b"");
        let mut inputdevicelist: *const libc::c_char = std::ptr::null();
        let mut defaultinputdevice: *const libc::c_char = std::ptr::null();
