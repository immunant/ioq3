...
unsafe extern "C" fn CL_UpdateMumble() {
    ...
    pos[1 as i32 as usize] = cl.snap.ps.origin[2 as i32 as usize] * scale;
    pos[2 as i32 as usize] = cl.snap.ps.origin[1 as i32 as usize] * scale;
    tmp = forward[1 as i32 as usize];
    forward[1 as i32 as usize] = forward[2 as i32 as usize];
    forward[2 as i32 as usize] = tmp;
    tmp = up[1 as i32 as usize];
    up[1 as i32 as usize] = up[2 as i32 as usize];
    up[2 as i32 as usize] = tmp;
    if (*cl_useMumble).integer > 1 as i32 {
        crate::stdlib::fprintf(
            crate::stdlib::stderr,
            b"%f %f %f, %f %f %f, %f %f %f\n\x00" as *const u8 as *const libc::c_char,
            pos[0 as i32 as usize] as f64,
            pos[1 as i32 as usize] as f64,
            pos[2 as i32 as usize] as f64,
            forward[0 as i32 as usize] as f64,
            forward[1 as i32 as usize] as f64,
            forward[2 as i32 as usize] as f64,
            up[0 as i32 as usize] as f64,
            up[1 as i32 as usize] as f64,
            up[2 as i32 as usize] as f64,
        );
    }
...
unsafe extern "C" fn CL_VoipNewGeneration() {
    ...
    if clc.voipOutgoingGeneration as i32 <= 0 as i32 {
        clc.voipOutgoingGeneration = 1 as i32 as crate::src::qcommon::q_shared::byte
    }
    clc.voipPower = 0.0f32;
    clc.voipOutgoingSequence = 0 as i32;
...
pub unsafe extern "C" fn CL_VoipParseTargets() {
    ...
    clc.voipFlags =
        (clc.voipFlags as i32 & !(0x1 as i32)) as crate::stdlib::uint8_t;
    while !target.is_null() {
        ...
        if val < 0 as i32 || val >= 64 as i32 {
            ...
            clc.voipTargets[(val / 8 as i32) as usize] =
                (clc.voipTargets[(val / 8 as i32) as usize] as i32
                    | (1 as i32) << val % 8 as i32)
...
unsafe extern "C" fn CL_CaptureVoip() {
    ...
    let useVad: crate::src::qcommon::q_shared::qboolean =
        ((*cl_voipUseVAD).integer != 0 as i32) as i32
    ...
    if (*cl_voipSend).modified as u64 != 0 {
            ...
            != crate::src::qcommon::q_shared::CA_ACTIVE as i32 as u32
        {
            ...
            dontCapture = crate::src::qcommon::q_shared::qtrue
        } else if (*cl_voip).integer == 0 as i32 {
            dontCapture = crate::src::qcommon::q_shared::qtrue
    ...
    if (*cl_voipSend).integer != 0 || finalFrame as u32 != 0 {
        ...
        if samples >= packetSamples {
            ...
            let mut i: i32 = 0;
            let mut bytes: i32 = 0;
            if samples > 20 as i32 * 48 as i32 * 3 as i32 {
                samples = 20 as i32 * 48 as i32 * 3 as i32
            }
            // !!! FIXME: maybe separate recording from encoding, so voipPower
            // !!! FIXME:  updates faster than 4Hz?
            samples -= samples % (20 as i32 * 48 as i32); // grab from audio card.
            if samples != 120 as i32
                && samples != 240 as i32
                && samples != 480 as i32
                && samples != 960 as i32
                && samples != 1920 as i32
            ...
            while i < samples {
                ...
                let s: f32 =
                    crate::stdlib::fabs(flsamp as f64) as f32;
                voipPower += s * s;
            ...
            clc.voipPower =
                voipPower / (32768.0f32 * 32768.0f32 * samples as f32) * 100.0f32;
            if useVad as u32 != 0 && clc.voipPower < (*cl_voipVADThreshold).value {
                CL_VoipNewGeneration();
...
pub unsafe extern "C" fn CL_AddReliableCommand(
    ...
    crate::src::qcommon::q_shared::Q_strncpyz(
        clc.reliableCommands
            [(clc.reliableSequence & 64 as i32 - 1 as i32) as usize]
            .as_mut_ptr(),
        cmd,
...
pub unsafe extern "C" fn CL_DemoFilename(
    ...
    let mut c: i32 = 0;
    let mut d: i32 = 0;
    if number < 0 as i32 || number > 9999 as i32 {
        number = 9999 as i32
    }
    a = number / 1000 as i32;
    number -= a * 1000 as i32;
    b = number / 100 as i32;
    number -= b * 100 as i32;
    c = number / 10 as i32;
    number -= c * 10 as i32;
...
unsafe extern "C" fn CL_DemoFrameDurationSDev() -> f32 {
    ...
    let mut mean: f32 = 0.0f32;
    let mut variance: f32 = 0.0f32;
    if clc.timeDemoFrames - 1 as i32 > 4096 as i32 {
        numFrames = 4096 as i32
    } else {
...
unsafe extern "C" fn CL_CompleteDemoName(mut _args: *mut libc::c_char, mut argNum: i32) {
    if argNum == 2 as i32 {
...
pub unsafe extern "C" fn CL_PlayDemo_f() {
    ...
    while clc.state as u32
        >= crate::src::qcommon::q_shared::CA_CONNECTED as i32 as u32
        && (clc.state as u32)
            < crate::src::qcommon::q_shared::CA_PRIMED as i32 as u32
    {
        CL_ReadDemoMessage();
    }
...
pub unsafe extern "C" fn CL_RequestMotd() {
    ...
    cls.updateServer.port =
        crate::src::qcommon::q_shared::ShortSwap(27951 as i32 as i16)
            as u16;
    crate::src::qcommon::common::Com_Printf(
        b"%s resolved to %i.%i.%i.%i:%i\n\x00" as *const u8 as *const libc::c_char,
        b"update.quake3arena.com\x00" as *const u8 as *const libc::c_char,
        cls.updateServer.ip[0 as i32 as usize] as i32,
        cls.updateServer.ip[1 as i32 as usize] as i32,
        cls.updateServer.ip[2 as i32 as usize] as i32,
        cls.updateServer.ip[3 as i32 as usize] as i32,
        crate::src::qcommon::q_shared::ShortSwap(cls.updateServer.port as i16)
            as i32,
    );
...
pub unsafe extern "C" fn CL_RequestAuthorization() {
    ...
    if cls.authorizeServer.port == 0 {
        ...
        crate::src::qcommon::common::Com_Printf(
            ...
            cls.authorizeServer.ip[1 as i32 as usize] as i32,
            cls.authorizeServer.ip[2 as i32 as usize] as i32,
            cls.authorizeServer.ip[3 as i32 as usize] as i32,
            crate::src::qcommon::q_shared::ShortSwap(cls.authorizeServer.port as i16)
                as i32,
        );
    }
    if cls.authorizeServer.type_0 as u32
...
pub unsafe extern "C" fn CL_Connect_f() {
    ...
    if clc.serverAddress.port as i32 == 0 as i32 {
        clc.serverAddress.port =
            crate::src::qcommon::q_shared::ShortSwap(27960 as i32 as i16)
                as u16
    }
    ...
    if (*cl_guidServerUniq).integer != 0 {
        CL_UpdateGUID(
            serverString,
            crate::stdlib::strlen(serverString) as i32,
        );
    } else {
        CL_UpdateGUID(0 as *const libc::c_char, 0 as i32);
    }
...
unsafe extern "C" fn CL_CompleteRcon(mut args: *mut libc::c_char, mut argNum: i32) {
    if argNum == 2 as i32 {
        // Skip "rcon "
            ...
            if !(i == clc.clientNum) {
                info = cl.gameState.stringData.as_mut_ptr().offset(
                    cl.gameState.stringOffsets
                        [(32 as i32 + 256 as i32 + 256 as i32 + i) as usize]
                        as isize,
                );
...
pub unsafe extern "C" fn CL_Rcon_f() {
    ...
    message[0 as i32 as usize] = -(1 as i32) as libc::c_char;
    message[1 as i32 as usize] = -(1 as i32) as libc::c_char;
    message[2 as i32 as usize] = -(1 as i32) as libc::c_char;
    message[3 as i32 as usize] = -(1 as i32) as libc::c_char;
    message[4 as i32 as usize] = 0 as i32 as libc::c_char;
    ...
    crate::src::qcommon::net_chan::NET_SendPacket(
        crate::qcommon_h::NS_CLIENT,
        crate::stdlib::strlen(message.as_mut_ptr()).wrapping_add(1 as i32 as libc::c_ulong)
            as i32,
...
pub unsafe extern "C" fn CL_CheckForResend() {
    ...
    if clc.state as u32
        != crate::src::qcommon::q_shared::CA_CONNECTING as i32 as u32
        && clc.state as u32
            != crate::src::qcommon::q_shared::CA_CHALLENGING as i32 as u32
    {
        return;
    } // for retransmit requests
    if cls.realtime - clc.connectTime < 3000 as i32 {
        return;
    }
    ...
    match clc.state as u32 {
        3 => {
            ...
            if (*crate::src::qcommon::common::com_standalone).integer == 0
                && clc.serverAddress.type_0 as u32
...
pub unsafe extern "C" fn CL_InitServerInfo(
    ...
    (*server).hostName[0 as i32 as usize] = '\u{0}' as i32 as libc::c_char;
    (*server).mapName[0 as i32 as usize] = '\u{0}' as i32 as libc::c_char;
    (*server).maxClients = 0 as i32;
    (*server).maxPing = 0 as i32;
    (*server).minPing = 0 as i32;
    (*server).ping = -(1 as i32);
    (*server).game[0 as i32 as usize] = '\u{0}' as i32 as libc::c_char;
    (*server).gameType = 0 as i32;
    (*server).netType = 0 as i32;
    (*server).punkbuster = 0 as i32;
    (*server).g_humanplayers = 0 as i32;
    (*server).g_needpass = 0 as i32;
}
/*
===================
...
pub unsafe extern "C" fn CL_ServersResponsePacket(
    ...
    while !(*buffptr as i32 == '\\' as i32
        || extended as u32 != 0 && *buffptr as i32 == '/' as i32)
    {
    ...
    while buffptr.offset(1 as i32 as isize) < buffend {
        // IPv4 address
        ...
        addresses[numservers as usize].port =
            ((*fresh7 as i32) << 8 as i32) as u16;
        let fresh8 = buffptr;
        buffptr = buffptr.offset(1);
        addresses[numservers as usize].port = (addresses[numservers as usize].port as i32
            + *fresh8 as i32)
            as u16;
        addresses[numservers as usize].port = crate::src::qcommon::q_shared::ShortSwap(
            addresses[numservers as usize].port as i16,
        ) as u16;
        // syntax check
    ...
    if count >= 4096 as i32 && cls.numGlobalServerAddresses < 4096 as i32 {
        // if we couldn't store the servers in the main list anymore
        while i < numservers && cls.numGlobalServerAddresses < 4096 as i32 {
...
pub unsafe extern "C" fn CL_CheckTimeout() {
    ...
    if (CL_CheckPaused() as u64 == 0 || (*crate::src::qcommon::common::sv_paused).integer == 0)
        ...
        && clc.state as u32
            != crate::src::qcommon::q_shared::CA_CINEMATIC as i32 as u32
        && (cls.realtime - clc.lastPacketTime) as f32
            > (*cl_timeout).value * 1000 as i32 as f32
    {
        cl.timeoutcount += 1;
...
pub unsafe extern "C" fn CL_Frame(mut msec: i32) {
        ...
        && msec != 0
    {
            ...
            || (*cl_forceavidemo).integer != 0
        {
            ...
            let mut frameDuration: f32 = (if 1000.0f32 / fps > 1.0f32 {
                (1000.0f32) / fps
            } else {
                1.0f32
    ...
    if (*crate::src::client::cl_scrn::cl_timegraph).integer != 0 {
        crate::src::client::cl_scrn::SCR_DebugGraph(
            (cls.realFrametime as f64 * 0.25f64) as f32,
        );
    }
...
pub unsafe extern "C" fn CL_RefMalloc(mut size: i32) -> *mut libc::c_void {
    return crate::src::qcommon::common::Z_TagMalloc(
        size,
        crate::qcommon_h::TAG_RENDERER as i32,
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn CL_InitRef() {
    ...
    ri.Cmd_Argv = Some(
        crate::src::qcommon::cmd::Cmd_Argv
            as unsafe extern "C" fn(_: i32) -> *mut libc::c_char,
    );
    ...
    ri.Printf = Some(
        CL_RefPrintf as unsafe extern "C" fn(_: i32, _: *const libc::c_char, _: ...) -> (),
    );
    ri.Error = Some(
        crate::src::qcommon::common::Com_Error
    ...
    ri.ftol = Some(
        crate::src::asm::ftola::qftolsse as unsafe extern "C" fn(_: f32) -> libc::c_long,
    );
    ri.Sys_SetEnv = Some(
...
pub unsafe extern "C" fn CL_Init() {
    ...
    crate::src::qcommon::cmd::Cmd_SetCommandCompletionFunc(
        b"demo\x00" as *const u8 as *const libc::c_char,
        Some(
            CL_CompleteDemoName as unsafe extern "C" fn(_: *mut libc::c_char, _: i32) -> (),
        ),
    );
    crate::src::qcommon::cmd::Cmd_AddCommand(
...
pub unsafe extern "C" fn CL_ServerInfoPacket(
    ...
    if cls.pingUpdateSource != 0 as i32 {
        return;
    }
    i = 0 as i32;
    while i < 128 as i32 {
        // empty slot
        if cls.localServers[i as usize].adr.port as i32 == 0 as i32 {
            break;
        }
        // avoid duplicate
        if crate::src::qcommon::net_ip::NET_CompareAdr(
    ...
    cls.numlocalservers = i + 1 as i32;
    CL_InitServerInfo(
        &mut *cls.localServers.as_mut_ptr().offset(i as isize),
        &mut from,
    );
...
pub unsafe extern "C" fn CL_GetServerStatus(
    ...
    i = 0 as i32;
    while i < 16 as i32 {
        if oldest == -(1 as i32) || cl_serverStatusList[i as usize].startTime < oldestTime {
            oldest = i;
...
pub unsafe extern "C" fn CL_ServerStatus(
    ...
    if serverAddress.is_null() {
        i = 0 as i32;
        while i < 16 as i32 {
            cl_serverStatusList[i as usize].address.port = 0 as i32 as u16;
        ...
        != 0
    {
        ...
        if (*serverStatus).pending as u64 == 0 {
            ...
            (*serverStatus).retrieved = crate::src::qcommon::q_shared::qtrue;
            (*serverStatus).startTime = 0 as i32;
...
pub unsafe extern "C" fn CL_LocalServers_f() {
    ...
    cls.numlocalservers = 0 as i32;
    cls.pingUpdateSource = 0 as i32;
    i = 0 as i32;
    while i < 128 as i32 {
...
pub unsafe extern "C" fn CL_GlobalServers_f() {
    ...
    if i == 0 {
        ...
        if i == 2 as i32 {
            to.port =
                crate::src::qcommon::q_shared::ShortSwap(27950 as i32 as i16)
                    as u16
        }
    }
    crate::src::qcommon::common::Com_Printf(
    ...
    if to.type_0 as u32 == crate::qcommon_h::NA_IP6 as i32 as u32
        || to.type_0 as u32
            == crate::qcommon_h::NA_MULTICAST6 as i32 as u32
    {
...
pub unsafe extern "C" fn CL_ClearPing(mut n: i32) {
    if n < 0 as i32 || n >= 32 as i32 {
        return;
    }
    cl_pinglist[n as usize].adr.port = 0 as i32 as u16;
}
/*
==================
...
pub unsafe extern "C" fn CL_GetFreePing() -> *mut crate::client_h::ping_t {
    ...
    while i < 32 as i32 {
        ...
        if (*pingptr).adr.port != 0 {
            ...
            } else if (*pingptr).time < 500 as i32 {
                current_block_3 = 735147466149431745;
            } else {
                current_block_3 = 1841672684692190573;
            }
        ...
        // clear it
        (*pingptr).adr.port = 0 as i32 as u16;
        return pingptr;
    }
    // use oldest entry
    pingptr = cl_pinglist.as_mut_ptr();
    best = cl_pinglist.as_mut_ptr();
    oldest = -(2147483647 as i32) - 1 as i32;
    i = 0 as i32;
    while i < 32 as i32 {
        // scan for oldest
...
pub unsafe extern "C" fn CL_UpdateVisiblePings_f(
    ...
    if source < 0 as i32 || source > 3 as i32 {
        return crate::src::qcommon::q_shared::qfalse;
    }
    ...
    if slots < 32 as i32 {
        ...
        while i < max {
            if (*server.offset(i as isize)).visible as u64 != 0 {
                if (*server.offset(i as isize)).ping == -(1 as i32) {
                    let mut j: i32 = 0;
                    if slots >= 32 as i32 {
                        break;
                    }
                ...
                } else if (*server.offset(i as isize)).ping == 0 as i32 {
                    // if the server has a ping higher than cl_maxPing or
                    // the ping packet got lost
                    // if we are updating global servers
                    if source == 2 as i32 {
                        //
                        if cls.numGlobalServerAddresses > 0 as i32 {
    ...
    while i < 32 as i32 {
        if !(cl_pinglist[i as usize].adr.port == 0) {
            CL_GetPing(i, buff.as_mut_ptr(), 1024 as i32, &mut pingTime);
            if pingTime != 0 as i32 {
                CL_ClearPing(i);
                status = crate::src::qcommon::q_shared::qtrue
            }
        }
...
pub unsafe extern "C" fn CL_CDKeyValidate(
    ...
    sum = 0 as i32 as crate::src::qcommon::q_shared::byte;
    ...
    while i < len {
        ...
        if ch as i32 >= 'a' as i32 && ch as i32 <= 'z' as i32 {
            ch = (ch as i32 - 32 as i32) as libc::c_char
        }
        match ch as i32 {
            50 | 51 | 55 | 65 | 66 | 67 | 68 | 71 | 72 | 74 | 76 | 80 | 82 | 83 | 84 | 87 => {
                sum =
                    (sum as i32 + ch as i32) as crate::src::qcommon::q_shared::byte;
                i += 1
            }
            _ => return crate::src::qcommon::q_shared::qfalse,
        }
