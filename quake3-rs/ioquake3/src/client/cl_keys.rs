...
pub static mut historyEditLines: [field_t; 32] = [field_t {
    cursor: 0,
    scroll: 0,
    widthInChars: 0,
    buffer: [0; 256],
...
pub static mut g_consoleField: field_t = field_t {
    cursor: 0,
    scroll: 0,
    widthInChars: 0,
    buffer: [0; 256],
...
pub static mut keynames: [keyname_t; 244] = [
    ...
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_LEFTSTICK_CLICK\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_LEFTSTICK_CLICK as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_RIGHTSTICK_CLICK\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_RIGHTSTICK_CLICK as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_LEFTSHOULDER as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_RIGHTSHOULDER\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_RIGHTSHOULDER as i32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_DPAD_DOWN as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_DPAD_LEFT as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_DPAD_RIGHT as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_LEFTSTICK_LEFT\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_LEFTSTICK_LEFT as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_LEFTSTICK_RIGHT\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_LEFTSTICK_RIGHT as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_LEFTSTICK_UP as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_LEFTSTICK_DOWN\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_LEFTSTICK_DOWN as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_RIGHTSTICK_LEFT\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_RIGHTSTICK_LEFT as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_RIGHTSTICK_RIGHT\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_RIGHTSTICK_RIGHT as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_RIGHTSTICK_UP\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_RIGHTSTICK_UP as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            name: b"PAD0_RIGHTSTICK_DOWN\x00" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            keynum: K_PAD0_RIGHTSTICK_DOWN as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_LEFTTRIGGER as i32,
        };
        init
    },
    {
        let mut init = keyname_t {
            ...
            keynum: K_PAD0_RIGHTTRIGGER as i32,
        };
        init
    },
    {
...
pub unsafe extern "C" fn Field_VariableSizeDraw(
    ...
    if showCursor as u64 != 0 {
        if cls.realtime >> 8 as i32 & 1 as i32 != 0 {
            return;
            // off blink
        }
...
pub unsafe extern "C" fn Field_CharEvent(mut edit: *mut field_t, mut ch: i32) {
    let mut len: i32 = 0;
    ...
    if ch == 'c' as i32 - 'a' as i32 + 1 as i32 {
        ...
        Field_Clear(edit as *mut field_t);
        return;
    }
    len = crate::stdlib::strlen((*edit).buffer.as_mut_ptr()) as i32;
...
pub unsafe extern "C" fn Console_Key(mut key: i32) {
    ...
    if key == 'l' as i32 && keys[K_CTRL as i32 as usize].down as u32 != 0 {
    ...
    // console scrolling
    if key == K_PGUP as i32 {
        Con_PageUp();
        return;
    }
    if key == K_PGDN as i32 {
        Con_PageDown();
        return;
    }
    if key == K_MWHEELUP as i32 {
        ...
        Con_PageUp();
        if keys[K_CTRL as i32 as usize].down as u64 != 0 {
...
pub unsafe extern "C" fn Key_IsDown(mut keynum: i32) -> qboolean {
    if keynum < 0 as i32 || keynum >= MAX_KEYS as i32 {
        return qfalse;
    }
...
pub unsafe extern "C" fn Key_StringToKeynum(mut str: *mut libc::c_char) -> i32 {
    ...
    if n >= 0 as i32 && n < MAX_KEYS as i32 {
        return n;
    }
    // scan for a text match
    kn = keynames.as_mut_ptr();
    while !(*kn).name.is_null() {
        if Q_stricmp(str, (*kn).name) == 0 {
            return (*kn).keynum;
        }
        kn = kn.offset(1)
    }
...
pub unsafe extern "C" fn Key_Unbind_f() {
    ...
    b = Key_StringToKeynum(Cmd_Argv(1 as i32));
    if b == -(1 as i32) {
        Com_Printf(
...
pub unsafe extern "C" fn Key_Bind_f() {
    ...
    i = 2 as i32;
    while i < c {
        libc::strcat(cmd.as_mut_ptr(), Cmd_Argv(i));
        if i != c - 1 as i32 {
            libc::strcat(
                cmd.as_mut_ptr(),
...
pub unsafe extern "C" fn Key_ClearStates() {
    ...
    while i < MAX_KEYS as i32 {
        if keys[i as usize].down as u64 != 0 {
            CL_KeyEvent(i, qfalse, 0 as i32 as u32);
        }
...
pub unsafe extern "C" fn CL_LoadConsoleHistory() {
    ...
    consoleSaveBufferSize = FS_FOpenFileRead(
        ...
        ) == consoleSaveBufferSize
    {
        ...
        while i >= 0 as i32 {
            ...
            if numChars as usize
                > crate::stdlib::strlen(consoleSaveBuffer.as_mut_ptr()).wrapping_sub(
                    text_p.offset_from(consoleSaveBuffer.as_mut_ptr()) as isize as usize,
                )
            {
                Com_DPrintf(
        ...
        crate::stdlib::memmove(
            ...
            (numLines as usize).wrapping_mul(::std::mem::size_of::<field_t>() as usize),
        );
        i = numLines;
        while i < 32 as i32 {
            Field_Clear(
