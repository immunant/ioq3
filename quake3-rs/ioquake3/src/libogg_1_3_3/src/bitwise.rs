...
static mut mask: [libc::c_ulong; 33] = [
    ...
    0x1 as i32 as libc::c_ulong,
    0x3 as i32 as libc::c_ulong,
    0x7 as i32 as libc::c_ulong,
    0xf as i32 as libc::c_ulong,
    0x1f as i32 as libc::c_ulong,
    0x3f as i32 as libc::c_ulong,
    0x7f as i32 as libc::c_ulong,
    0xff as i32 as libc::c_ulong,
    0x1ff as i32 as libc::c_ulong,
    0x3ff as i32 as libc::c_ulong,
    0x7ff as i32 as libc::c_ulong,
    0xfff as i32 as libc::c_ulong,
    0x1fff as i32 as libc::c_ulong,
    0x3fff as i32 as libc::c_ulong,
    0x7fff as i32 as libc::c_ulong,
    0xffff as i32 as libc::c_ulong,
    0x1ffff as i32 as libc::c_ulong,
    0x3ffff as i32 as libc::c_ulong,
    0x7ffff as i32 as libc::c_ulong,
    0xfffff as i32 as libc::c_ulong,
    0x1fffff as i32 as libc::c_ulong,
    0x3fffff as i32 as libc::c_ulong,
    0x7fffff as i32 as libc::c_ulong,
    0xffffff as i32 as libc::c_ulong,
    0x1ffffff as i32 as libc::c_ulong,
    0x3ffffff as i32 as libc::c_ulong,
    0x7ffffff as i32 as libc::c_ulong,
    0xfffffff as i32 as libc::c_ulong,
    0x1fffffff as i32 as libc::c_ulong,
    0x3fffffff as i32 as libc::c_ulong,
    0x7fffffff as i32 as libc::c_ulong,
    0xffffffff as u32 as libc::c_ulong,
];
...
pub unsafe extern "C" fn oggpack_writetrunc(
    ...
    if !(*b).ptr.is_null() {
        ...
        (*b).endbyte = bytes;
        *(*b).ptr = (*(*b).ptr as libc::c_ulong & mask[bits as usize]) as u8
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn oggpack_write(
    ...
    if !(bits < 0 as i32 || bits > 32 as i32) {
        if (*b).endbyte >= (*b).storage - 4 as i32 as libc::c_long {
            ...
            if (*b).storage
                > 9223372036854775807 as libc::c_long - 256 as i32 as libc::c_long
            {
        ...
        match current_block {
            ...
            _ => {
                ...
                *fresh0 = (*fresh0 as libc::c_ulong | value << (*b).endbit) as u8;
                if bits >= 8 as i32 {
                    *(*b).ptr.offset(1 as i32 as isize) =
    ...
    if !(bits < 0 as i32 || bits > 32 as i32) {
        ...
        match current_block {
            ...
            _ => {
                ...
                *fresh1 = (*fresh1 as libc::c_ulong | value >> 24 as i32 + (*b).endbit)
                    as u8;
                if bits >= 8 as i32 {
                    *(*b).ptr.offset(1 as i32 as isize) =
                        (value >> 16 as i32 + (*b).endbit) as u8;
...
pub unsafe extern "C" fn oggpack_writealign(mut b: *mut crate::ogg_h::oggpack_buffer) {
    ...
    if bits < 8 as i32 {
        oggpack_write(b, 0 as i32 as libc::c_ulong, bits);
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn oggpackB_writealign(mut b: *mut crate::ogg_h::oggpack_buffer) {
    let mut bits: i32 = 8 as i32 - (*b).endbit;
    if bits < 8 as i32 {
        oggpackB_write(b, 0 as i32 as libc::c_ulong, bits);
    };
}
...
unsafe extern "C" fn oggpack_writecopy_helper(
    ...
    let mut pbytes: libc::c_long =
        ((*b).endbit as libc::c_long + bits) / 8 as i32 as libc::c_long;
    bits -= bytes * 8 as i32 as libc::c_long;
    ...
    if bits != 0 {
        if msb != 0 {
            w.expect("non-null function pointer")(
                b,
                (*ptr.offset(bytes as isize) as i32
                    >> 8 as i32 as libc::c_long - bits) as libc::c_ulong,
                bits as i32,
            );
        } else {
            w.expect("non-null function pointer")(
...
pub unsafe extern "C" fn oggpack_look(
    ...
    if (*b).endbyte >= (*b).storage - 4 as i32 as libc::c_long {
        /* not the main path */
        if (*b).endbyte
            > (*b).storage - (bits + 7 as i32 >> 3 as i32) as libc::c_long
        {
            return -(1 as i32) as libc::c_long;
        } else {
    ...
    ret = (*(*b).ptr.offset(0 as i32 as isize) as i32 >> (*b).endbit)
        as libc::c_ulong;
    if bits > 8 as i32 {
        ret |= ((*(*b).ptr.offset(1 as i32 as isize) as i32)
            << 8 as i32 - (*b).endbit) as libc::c_ulong;
        if bits > 16 as i32 {
            ret |= ((*(*b).ptr.offset(2 as i32 as isize) as i32)
                << 16 as i32 - (*b).endbit) as libc::c_ulong;
            if bits > 24 as i32 {
                ret |= ((*(*b).ptr.offset(3 as i32 as isize) as i32)
                    << 24 as i32 - (*b).endbit) as libc::c_ulong;
...
pub unsafe extern "C" fn oggpackB_look(
    ...
    ret = ((*(*b).ptr.offset(0 as i32 as isize) as i32)
        << 24 as i32 + (*b).endbit) as libc::c_ulong;
    if bits > 8 as i32 {
        ret |= ((*(*b).ptr.offset(1 as i32 as isize) as i32)
            << 16 as i32 + (*b).endbit) as libc::c_ulong;
...
pub unsafe extern "C" fn oggpack_look1(mut b: *mut crate::ogg_h::oggpack_buffer) -> libc::c_long {
    ...
    return (*(*b).ptr.offset(0 as i32 as isize) as i32 >> (*b).endbit
...
pub unsafe extern "C" fn oggpackB_look1(mut b: *mut crate::ogg_h::oggpack_buffer) -> libc::c_long {
    ...
    return (*(*b).ptr.offset(0 as i32 as isize) as i32
        >> 7 as i32 - (*b).endbit
        & 1 as i32) as libc::c_long;
}
#[no_mangle]
                    ...
                    if bits > 16 as i32 {
                        ...
                        if bits > 24 as i32 {
                            ret |= ((*(*b).ptr.offset(3 as i32 as isize) as i32)
                                ...
                                as libc::c_long;
                            if bits > 32 as i32 && (*b).endbit != 0 {
                                ret |= ((*(*b).ptr.offset(4 as i32 as isize)
                                    as i32)
                                    << 32 as i32 - (*b).endbit)
                                    as libc::c_long
                            }
...
pub unsafe extern "C" fn oggpackB_read(
    ...
    if !(m < 0 as i32 as libc::c_long || m > 32 as i32 as libc::c_long) {
        ...
        match current_block {
            ...
            _ => {
                ret = ((*(*b).ptr.offset(0 as i32 as isize) as i32)
                    << 24 as i32 + (*b).endbit) as libc::c_long;
                if bits > 8 as i32 {
                    ret |= ((*(*b).ptr.offset(1 as i32 as isize) as i32)
                        << 16 as i32 + (*b).endbit)
                        as libc::c_long;
