...
pub static mut aasworld: aas_t = aas_t {
    ...
    numareasettings: 0,
    areasettings: std::ptr::null_mut(),
    reachabilitysize: 0,
    reachability: std::ptr::null_mut(),
    numnodes: 0,
    nodes: std::ptr::null_mut(),
    numportals: 0,
    portals: std::ptr::null_mut(),
    portalindexsize: 0,
    portalindex: std::ptr::null_mut(),
    numclusters: 0,
    clusters: std::ptr::null_mut(),
    numreachabilityareas: 0,
    reachabilitytime: 0.,
    linkheap: std::ptr::null_mut(),
    linkheapsize: 0,
    freelinks: std::ptr::null_mut(),
    arealinkedentities: std::ptr::null_mut(),
    maxentities: 0,
    maxclients: 0,
    entities: std::ptr::null_mut(),
    travelflagfortype: [0; 32],
    areacontentstravelflags: std::ptr::null_mut(),
    areaupdate: std::ptr::null_mut(),
    portalupdate: std::ptr::null_mut(),
    frameroutingupdates: 0,
    reversedreachability: std::ptr::null_mut(),
    areatraveltimes: std::ptr::null_mut(),
    clusterareacache: std::ptr::null_mut(),
    portalcache: std::ptr::null_mut(),
    oldestcache: std::ptr::null_mut(),
    newestcache: std::ptr::null_mut(),
    portalmaxtraveltimes: std::ptr::null_mut(),
    reachabilityareaindex: std::ptr::null_mut(),
    reachabilityareas: std::ptr::null_mut(),
};
#[no_mangle]

pub static mut saveroutingcache: *mut libvar_t = std::ptr::null_mut();
//===========================================================================
//
// Parameter:				-
// Returns:					-
