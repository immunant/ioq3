        ...
        },
        {
            let mut init = crate::src::botlib::l_struct::fielddef_s {
                ...
                offset: &mut (*(0 as *mut crate::src::botlib::be_ai_weap::weaponinfo_t)).hspread
                    as *mut f32 as crate::stddef_h::size_t
                    as i32,
                type_0: 3 as i32,
                maxarray: 0,
                floatmin: 0.,
