...
pub unsafe extern "C" fn zlibCompileFlags() -> uLong {
    ...
    match ::std::mem::size_of::<uInt>() as usize {
        2 => {}
        4 => flags = (flags as usize).wrapping_add(1 as i32 as usize) as uLong,
        8 => flags = (flags as usize).wrapping_add(2 as i32 as usize) as uLong,
        _ => flags = (flags as usize).wrapping_add(3 as i32 as usize) as uLong,
    }
...
pub unsafe extern "C" fn zcalloc(mut opaque: voidpf, mut items: u32, mut size: u32) -> voidpf {
    ...
    return if ::std::mem::size_of::<uInt>() as usize > 2 as i32 as usize {
