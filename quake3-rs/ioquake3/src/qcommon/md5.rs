...
unsafe extern "C" fn MD5Init(mut ctx: *mut MD5Context) {
    (*ctx).buf[0 as i32 as usize] = 0x67452301 as i32 as crate::stdlib::uint32_t;
    (*ctx).buf[1 as i32 as usize] = 0xefcdab89 as u32;
    (*ctx).buf[2 as i32 as usize] = 0x98badcfe as u32;
    (*ctx).buf[3 as i32 as usize] = 0x10325476 as i32 as crate::stdlib::uint32_t;
    (*ctx).bits[0 as i32 as usize] = 0 as i32 as crate::stdlib::uint32_t;
    (*ctx).bits[1 as i32 as usize] = 0 as i32 as crate::stdlib::uint32_t;
}
