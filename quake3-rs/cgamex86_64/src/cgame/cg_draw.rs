...
pub static mut drawTeamOverlayModificationCount: i32 = -(1 as i32);
#[no_mangle]
...
pub unsafe extern "C" fn CG_Draw3DModel(
    ...
    refdef.fov_x = 30 as i32 as f32;
    refdef.fov_y = 30 as i32 as f32;
    refdef.x = x as i32;
    refdef.y = y as i32;
...
unsafe extern "C" fn CG_DrawStatusBarHead(mut x: f32) {
    ...
    if cg.damageTime != 0. && cg.time as f32 - cg.damageTime < 500 as i32 as f32 {
        ...
        size = (48 as i32 as f64 * 1.25f64) as f32
    }
...
unsafe extern "C" fn CG_DrawStatusBar() {
    ...
    if cg_drawStatus.integer == 0 as i32 {
        return;
    }
    ...
    {
        origin[0 as i32 as usize] = 70 as i32 as vec_t;
...
unsafe extern "C" fn CG_DrawAttacker(mut y: f32) -> f32 {
    ...
    angles[1 as i32 as usize] = 180 as i32 as vec_t;
    angles[2 as i32 as usize] = 0 as i32 as vec_t;
    CG_DrawHead(
    ...
    y += size;
    CG_DrawBigString(
        640 as i32 - Q_PrintStrlen(name) * 16 as i32,
        y as i32,
        name,
        0.5f64 as f32,
    );
    return y + 16 as i32 as f32 + 2 as i32 as f32;
}
/*
==================
CG_DrawSnapshot
...
unsafe extern "C" fn CG_DrawFPS(mut y: f32) -> f32 {
    ...
    if index > 4 as i32 {
        ...
        fps = 1000 as i32 * 4 as i32 / total;
        s = va(
...
unsafe extern "C" fn CG_DrawTimer(mut y: f32) -> f32 {
    ...
    seconds = msec / 1000 as i32;
    mins = seconds / 60 as i32;
    seconds -= mins * 60 as i32;
    tens = seconds / 10 as i32;
    seconds -= tens * 10 as i32;
    s = va(
...
unsafe extern "C" fn CG_DrawTeamOverlay(
    ...
    pwidth = 0 as i32;
    count = if numSortedTeamPlayers > 8 as i32 {
        8 as i32
    } else {
    ...
    w = (pwidth + lwidth + 4 as i32 + 7 as i32) * 8 as i32;
    if right as u64 != 0 {
        x = 640 as i32 - w
    } else {
        x = 0 as i32
    }
    h = plyrs * (16 as i32 / 2 as i32);
    if upper as u64 != 0 {
    ...
    while i < count {
                ...
                == (*cg.snap).ps.persistant[crate::bg_public_h::PERS_TEAM as i32 as usize] as u32
        {
            ...
            if lwidth != 0 {
                ...
                xx = x + 8 as i32 * 2 as i32 + 8 as i32 * pwidth;
                CG_DrawStringExt(
                    xx,
                    y as i32,
                    p,
...
unsafe extern "C" fn CG_DrawUpperRight(mut stereoFrame: stereoFrame_t) {
    ...
    if cg_drawFPS.integer != 0
        && (stereoFrame as u32 == STEREO_CENTER as i32 as u32
            || stereoFrame as u32 == STEREO_RIGHT as i32 as u32)
    {
        y = CG_DrawFPS(y)
    }
...
unsafe extern "C" fn CG_DrawScores(mut y: f32) -> f32 {
    ...
    if cgs.gametype as u32 >= crate::bg_public_h::GT_TEAM as i32 as u32 {
        ...
        color[3 as i32 as usize] = 0.33f32;
        s = va(
            b"%2i\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            s2,
        );
        w = CG_DrawStrlen(s) * 16 as i32 + 8 as i32;
        x -= w;
        CG_FillRect(
            x as f32,
            y - 4 as i32 as f32,
        ...
        color[0 as i32 as usize] = 1.0f32;
        color[1 as i32 as usize] = 0.0f32;
        ...
        if s2 != -(9999 as i32) {
            ...
            if spectator as u64 == 0 && score == s2 && score != s1 {
                ...
                color[0 as i32 as usize] = 0.5f32;
                color[1 as i32 as usize] = 0.5f32;
                color[2 as i32 as usize] = 0.5f32;
                color[3 as i32 as usize] = 0.33f32;
                CG_FillRect(
                    x as f32,
                    y - 4 as i32 as f32,
...
unsafe extern "C" fn CG_DrawPowerups(mut y: f32) -> f32 {
    ...
    while i < 16 as i32 {
        if !((*ps).powerups[i as usize] == 0) {
            ...
            if !((*ps).powerups[i as usize] == 2147483647 as i32) {
...
unsafe extern "C" fn CG_DrawTeamInfo() {
    ...
    if cgs.teamLastChatPos != cgs.teamChatPos {
            ...
            == crate::bg_public_h::TEAM_BLUE as i32 as u32
        {
            ...
            hcolor[0 as i32 as usize] = 0.0f32;
            hcolor[1 as i32 as usize] = 1.0f32;
            hcolor[2 as i32 as usize] = 0.0f32;
            hcolor[3 as i32 as usize] = 0.33f32
        }
        crate::src::cgame::cg_syscalls::trap_R_SetColor(hcolor.as_mut_ptr());
        ...
        hcolor[1 as i32 as usize] = hcolor[2 as i32 as usize];
        hcolor[0 as i32 as usize] = hcolor[1 as i32 as usize];
        hcolor[3 as i32 as usize] = 1.0f32;
        i = cgs.teamChatPos - 1 as i32;
        while i >= cgs.teamLastChatPos {
            CG_DrawStringExt(
                0 as i32 + 8 as i32,
                420 as i32 - (cgs.teamChatPos - i) * (16 as i32 / 2 as i32),
...
unsafe extern "C" fn CG_DrawReward() {
    ...
    if color.is_null() {
        if cg.rewardStack > 0 as i32 {
            i = 0 as i32;
            while i < cg.rewardStack {
                cg.rewardSound[i as usize] = cg.rewardSound[(i + 1 as i32) as usize];
                cg.rewardShader[i as usize] = cg.rewardShader[(i + 1 as i32) as usize];
                cg.rewardCount[i as usize] = cg.rewardCount[(i + 1 as i32) as usize];
                i += 1
            }
    ...
    */
    if cg.rewardCount[0 as i32 as usize] >= 10 as i32 {
        y = 56 as i32 as f32;
        x = (320 as i32 - 48 as i32 / 2 as i32) as f32;
        CG_DrawPic(
            x,
            y,
            (48 as i32 - 4 as i32) as f32,
            (48 as i32 - 4 as i32) as f32,
            cg.rewardShader[0 as i32 as usize],
        );
        Com_sprintf(
            buf.as_mut_ptr(),
        ...
        count = cg.rewardCount[0 as i32 as usize];
        y = 56 as i32 as f32;
        x = (320 as i32 - count * 48 as i32 / 2 as i32) as f32;
        i = 0 as i32;
        while i < count {
            CG_DrawPic(
                x,
...
unsafe extern "C" fn CG_DrawLagometer() {
    ...
    if cg_lagometer.integer == 0 || cgs.localServer as u32 != 0 {
        CG_DrawDisconnect();
        return;
    }
    //
    ...
    color = -(1 as i32);
    range = ah / 3 as i32 as f32;
    mid = ay + range;
    vscale = range / 300 as i32 as f32;
    // draw the frame interpoalte / extrapolate graph
    a = 0 as i32;
    while (a as f32) < aw {
        i = lagometer.frameCount - 1 as i32 - a & 128 as i32 - 1 as i32;
    ...
    range = ah / 2 as i32 as f32; // YELLOW for rate delay
    vscale = range / 900 as i32 as f32; // RED for dropped snapshots
    a = 0 as i32;
    while (a as f32) < aw {
        i = lagometer.snapshotCount - 1 as i32 - a & 128 as i32 - 1 as i32;
...
unsafe extern "C" fn CG_DrawCenterString() {
    ...
    color = CG_FadeColor(
        cg.centerPrintTime,
        (1000 as i32 as f32 * cg_centertime.value) as i32,
    );
    if color.is_null() {
        return;
    }
    ...
    loop {
        ...
        linebuffer[l as usize] = 0 as i32 as libc::c_char;
...
unsafe extern "C" fn CG_DrawCrosshair() {
    ...
    f = (cg.time - cg.itemPickupBlendTime) as f32;
    if f > 0 as i32 as f32 && f < 200 as i32 as f32 {
        f /= 200 as i32 as f32;
        w *= 1 as i32 as f32 + f;
        h *= 1 as i32 as f32 + f
    }
    x = cg_crosshairX.integer as f32;
    y = cg_crosshairY.integer as f32;
    CG_AdjustFrom640(&mut x, &mut y, &mut w, &mut h);
...
unsafe extern "C" fn CG_DrawCrosshair3D() {
    ...
    ent.origin[0 as i32 as usize] = trace.endpos[0 as i32 as usize];
    ent.origin[1 as i32 as usize] = trace.endpos[1 as i32 as usize];
    ent.origin[2 as i32 as usize] = trace.endpos[2 as i32 as usize];
...
unsafe extern "C" fn CG_ScanForCrosshairEntity() {
    ...
    start[0 as i32 as usize] = cg.refdef.vieworg[0 as i32 as usize];
    ...
    crate::src::cgame::cg_predict::CG_Trace(
        ...
        (*cg.snap).ps.clientNum,
        1 as i32 | 0x2000000 as i32,
    );
    if trace.entityNum >= 64 as i32 {
        return;
    }
...
unsafe extern "C" fn CG_DrawVote() {
    ...
    CG_DrawSmallString(0 as i32, 58 as i32, s, 1.0f32);
}
/*
=================
CG_DrawTeamVote
...
unsafe extern "C" fn CG_DrawTeamVote() {
    ...
    CG_DrawSmallString(0 as i32, 90 as i32, s, 1.0f32);
}
...
unsafe extern "C" fn CG_DrawWarmup() {
    ...
    if cgs.gametype as u32 == crate::bg_public_h::GT_TOURNAMENT as i32 as u32 {
        ...
        if !ci1.is_null() && !ci2.is_null() {
            ...
            w = CG_DrawStrlen(s);
            if w > 640 as i32 / 32 as i32 {
                cw = 640 as i32 / w
            } else {
                cw = 32 as i32
            }
            CG_DrawStringExt(
                320 as i32 - w * cw / 2 as i32,
                20 as i32,
                s,
...
pub unsafe extern "C" fn CG_DrawActive(mut stereoView: stereoFrame_t) {
    ...
    CG_TileClear();
    if stereoView as u32 != STEREO_CENTER as i32 as u32 {
        CG_DrawCrosshair3D();
    }
    // draw 3D view
