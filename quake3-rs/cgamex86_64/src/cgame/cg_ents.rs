...
unsafe extern "C" fn CG_EntityEffects(mut cent: *mut centity_t) {
    ...
    if (*cent).currentState.loopSound != 0 {
        if (*cent).currentState.eType != ET_SPEAKER as i32 {
...
unsafe extern "C" fn CG_Item(mut cent: *mut centity_t) {
    ...
    if cg_simpleItems.integer == 0 {
        ...
        spinAngles[2 as i32 as usize] = 0 as i32 as vec_t;
...
unsafe extern "C" fn CG_Missile(mut cent: *mut centity_t) {
    ...
    */
    ...
    ent.oldorigin[1 as i32 as usize] = (*cent).lerpOrigin[1 as i32 as usize];
    ent.oldorigin[2 as i32 as usize] = (*cent).lerpOrigin[2 as i32 as usize];
    if (*cent).currentState.weapon == WP_PLASMAGUN as i32 {
        ent.reType = RT_SPRITE;
    ...
    ent.skinNum = cg.clientFrame & 1 as i32;
    ...
    CG_AddRefEntityWithPowerups(
        &mut ent as *mut _ as *mut refEntity_t,
        s1 as *mut entityState_s,
        TEAM_FREE as i32,
    );
}
/*
...
unsafe extern "C" fn CG_Mover(mut cent: *mut centity_t) {
    ...
    ent.skinNum = cg.time >> 6 as i32 & 1 as i32;
...
unsafe extern "C" fn CG_InterpolateEntityPosition(mut cent: *mut centity_t) {
    ...
    BG_EvaluateTrajectory(
        &mut (*cent).nextState.pos as *mut _ as *const trajectory_t,
    ...
    BG_EvaluateTrajectory(
        &mut (*cent).nextState.apos as *mut _ as *const trajectory_t,
        (*cg.nextSnap).serverTime,
        next.as_mut_ptr(),
    );
...
unsafe extern "C" fn CG_TeamBase(mut cent: *mut centity_t) {
    ...
    if cgs.gametype as u32 == GT_CTF as i32 as u32 {
        ...
        if (*cent).currentState.modelindex == TEAM_RED as i32 {
            model.hModel = cgs.media.redFlagBaseModel
        } else if (*cent).currentState.modelindex == TEAM_BLUE as i32 {
...
unsafe extern "C" fn CG_AddCEntity(mut cent: *mut centity_t) {
    ...
    match (*cent).currentState.eType {
        ...
        1 => {
            CG_Player(cent as *mut centity_s);
        }
        2 => {
            CG_Item(cent);
        }
