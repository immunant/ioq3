...
static mut s_mods: mods_t = mods_t {
    ...
    description: [0; 3072],
    fs_game: [0; 1024],
    descriptionPtr: std::ptr::null_mut(),
    fs_gamePtr: std::ptr::null_mut(),
    descriptionList: [std::ptr::null_mut(); 64],
    fs_gameList: [std::ptr::null_mut(); 64],
};
/*
===============
UI_Mods_MenuEvent
...
pub unsafe extern "C" fn UI_ModsMenu() {
    UI_Mods_MenuInit();
    UI_PushMenu(&mut s_mods.menu as *mut _ as *mut _tag_menuframework);
}
