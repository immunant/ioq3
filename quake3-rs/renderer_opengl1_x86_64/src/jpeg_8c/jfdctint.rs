...
pub unsafe extern "C" fn jpeg_fdct_islow(
    ...
    while ctr < 8 as i32 {
        ...
        *dataptr.offset(6 as i32 as isize) =
        ...
        tmp12 = tmp0 + tmp2;
        tmp13 = tmp1 + tmp3;
        z1 = (tmp12 + tmp13) * 9633 as i32 as INT32;
        z1 += (1 as i32 as INT32) << 13 as i32 - 2 as i32 - 1 as i32;
        tmp0 = tmp0 * 12299 as i32 as INT32;
        tmp1 = tmp1 * 25172 as i32 as INT32;
        tmp2 = tmp2 * 16819 as i32 as INT32;
        tmp3 = tmp3 * 2446 as i32 as INT32;
        tmp10 = tmp10 * -(7373 as i32 as INT32);
        tmp11 = tmp11 * -(20995 as i32 as INT32);
        tmp12 = tmp12 * -(3196 as i32 as INT32);
        tmp13 = tmp13 * -(16069 as i32 as INT32);
        tmp12 += z1;
        tmp13 += z1;
        *dataptr.offset(1 as i32 as isize) =
            (tmp0 + tmp10 + tmp12 >> 13 as i32 - 2 as i32) as DCTELEM;
        *dataptr.offset(3 as i32 as isize) =
            (tmp1 + tmp11 + tmp13 >> 13 as i32 - 2 as i32) as DCTELEM;
        *dataptr.offset(5 as i32 as isize) =
            (tmp2 + tmp11 + tmp12 >> 13 as i32 - 2 as i32) as DCTELEM;
        *dataptr.offset(7 as i32 as isize) =
            (tmp3 + tmp10 + tmp13 >> 13 as i32 - 2 as i32) as DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_7x7(
    ...
    crate::stdlib::memset(
        ...
        0 as i32,
        (::std::mem::size_of::<DCTELEM>() as usize).wrapping_mul(64 as i32 as usize),
    );
    /* Pass 1: process rows. */
    /* Note results are scaled up by sqrt(8) compared to a true DCT; */
    /* furthermore, we scale the results by 2**PASS1_BITS. */
...
pub unsafe extern "C" fn jpeg_fdct_5x5(
    ...
    while ctr < 5 as i32 {
        ...
        tmp1 = (*elemptr.offset(1 as i32 as isize) as i32
            + *elemptr.offset(3 as i32 as isize) as i32) as INT32;
        tmp2 = *elemptr.offset(2 as i32 as isize) as i32 as INT32;
        tmp10 = tmp0 + tmp1;
        tmp11 = tmp0 - tmp1;
        tmp0 = (*elemptr.offset(0 as i32 as isize) as i32
            - *elemptr.offset(4 as i32 as isize) as i32) as INT32;
    ...
    while ctr >= 0 as i32 {
        ...
        *dataptr.offset((8 as i32 * 5 as i32) as isize) =
            (tmp2 + ((1 as i32 as INT32) << 13 as i32 + 2 as i32 - 1 as i32)
                >> 13 as i32 + 2 as i32) as DCTELEM;
        *dataptr.offset((8 as i32 * 7 as i32) as isize) =
            (tmp3 + ((1 as i32 as INT32) << 13 as i32 + 2 as i32 - 1 as i32)
                >> 13 as i32 + 2 as i32) as DCTELEM;
        dataptr = dataptr.offset(1);
        wsptr = wsptr.offset(1);
        ctr -= 1
...
pub unsafe extern "C" fn jpeg_fdct_12x12(
    ...
    loop {
        ...
        *dataptr.offset(2 as i32 as isize) = (tmp14 - tmp15
            ...
            >> 13 as i32) as DCTELEM;
        /* Odd part */
        tmp10 = (tmp1 + tmp4) * 4433 as i32 as INT32; /* c9 */
    ...
    while ctr >= 0 as i32 {
        ...
        *dataptr.offset((8 as i32 * 1 as i32) as isize) =
            (tmp10 + ((1 as i32 as INT32) << 13 as i32 + 1 as i32 - 1 as i32)
                >> 13 as i32 + 1 as i32) as DCTELEM;
        *dataptr.offset((8 as i32 * 3 as i32) as isize) =
            (tmp11 + ((1 as i32 as INT32) << 13 as i32 + 1 as i32 - 1 as i32)
                >> 13 as i32 + 1 as i32) as DCTELEM;
        *dataptr.offset((8 as i32 * 5 as i32) as isize) =
            (tmp12 + ((1 as i32 as INT32) << 13 as i32 + 1 as i32 - 1 as i32)
                >> 13 as i32 + 1 as i32) as DCTELEM;
        *dataptr.offset((8 as i32 * 7 as i32) as isize) =
            (tmp13 + ((1 as i32 as INT32) << 13 as i32 + 1 as i32 - 1 as i32)
                >> 13 as i32 + 1 as i32) as DCTELEM;
        dataptr = dataptr.offset(1);
        wsptr = wsptr.offset(1);
        ctr -= 1
...
pub unsafe extern "C" fn jpeg_fdct_16x16(
    ...
    while ctr >= 0 as i32 {
        ...
        *dataptr.offset((8 as i32 * 0 as i32) as isize) = (tmp10
            ...
            + tmp12
            + tmp13
            + ((1 as i32 as INT32) << 2 as i32 + 2 as i32 - 1 as i32)
            >> 2 as i32 + 2 as i32)
            as DCTELEM;
        *dataptr.offset((8 as i32 * 4 as i32) as isize) = ((tmp10 - tmp13)
            * (1.306562965f64 * ((1 as i32 as INT32) << 13 as i32) as f64 + 0.5f64) as INT32
...
pub unsafe extern "C" fn jpeg_fdct_8x4(
    ...
    while ctr < 4 as i32 {
        ...
        *dataptr.offset(6 as i32 as isize) =
        ...
        tmp13 += z1;
        *dataptr.offset(1 as i32 as isize) =
            (tmp0 + tmp10 + tmp12 >> 13 as i32 - 2 as i32 - 1 as i32) as DCTELEM;
        *dataptr.offset(3 as i32 as isize) =
            (tmp1 + tmp11 + tmp13 >> 13 as i32 - 2 as i32 - 1 as i32) as DCTELEM;
        *dataptr.offset(5 as i32 as isize) =
            (tmp2 + tmp11 + tmp12 >> 13 as i32 - 2 as i32 - 1 as i32) as DCTELEM;
        *dataptr.offset(7 as i32 as isize) =
            (tmp3 + tmp10 + tmp13 >> 13 as i32 - 2 as i32 - 1 as i32) as DCTELEM;
        dataptr = dataptr.offset(8 as i32 as isize);
        ctr += 1
    }
    /* Even part per LL&M figure 1 --- note that published figure is faulty;
...
pub unsafe extern "C" fn jpeg_fdct_2x1(
    ...
    *data.offset(0 as i32 as isize) =
    ...
    /* Odd part */
    *data.offset(1 as i32 as isize) = (tmp0 - tmp1 << 5 as i32) as DCTELEM;
}
/*
...
pub unsafe extern "C" fn jpeg_fdct_8x16(
    ...
    loop {
        ...
        *dataptr.offset(6 as i32 as isize) = (z1 - tmp13 * 15137 as i32 as INT32
        ...
        z1 = (tmp12 + tmp13) * 9633 as i32 as INT32; /* -c1+c3+c5-c7 */
        tmp0 = tmp0 * 12299 as i32 as INT32; /*  c7-c3 */
        tmp1 = tmp1 * 25172 as i32 as INT32; /* -c1-c3 */
        tmp2 = tmp2 * 16819 as i32 as INT32; /*  c5-c3 */
        tmp3 = tmp3 * 2446 as i32 as INT32; /* -c3-c5 */
        tmp10 = tmp10 * -(7373 as i32 as INT32); /* Done. */
        tmp11 = tmp11 * -(20995 as i32 as INT32);
        tmp12 = tmp12 * -(3196 as i32 as INT32);
        tmp13 = tmp13 * -(16069 as i32 as INT32);
        tmp12 += z1;
