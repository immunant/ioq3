...
pub unsafe extern "C" fn jpeg_fdct_islow(
    ...
    while ctr < 8 as i32 {
        ...
        *dataptr.offset(0 as i32 as isize) =
            ((tmp10 + tmp11 - (8 as i32 * 128 as i32) as libc::c_long)
        ...
        *dataptr.offset(6 as i32 as isize) =
        ...
        tmp12 += z1;
        tmp13 += z1;
        *dataptr.offset(1 as i32 as isize) = (tmp0 + tmp10 + tmp12
            >> 13 as i32 - 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset(3 as i32 as isize) = (tmp1 + tmp11 + tmp13
            >> 13 as i32 - 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset(5 as i32 as isize) = (tmp2 + tmp11 + tmp12
            >> 13 as i32 - 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset(7 as i32 as isize) = (tmp3 + tmp10 + tmp13
            >> 13 as i32 - 2 as i32)
            as crate::jdct_h::DCTELEM;
    ...
    while ctr >= 0 as i32 {
        ...
        *dataptr.offset((8 as i32 * 6 as i32) as isize) =
        ...
        tmp12 += z1;
        tmp13 += z1;
        *dataptr.offset((8 as i32 * 1 as i32) as isize) = (tmp0 + tmp10 + tmp12
            >> 13 as i32 + 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset((8 as i32 * 3 as i32) as isize) = (tmp1 + tmp11 + tmp13
            >> 13 as i32 + 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset((8 as i32 * 5 as i32) as isize) = (tmp2 + tmp11 + tmp12
            >> 13 as i32 + 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset((8 as i32 * 7 as i32) as isize) = (tmp3 + tmp10 + tmp13
            >> 13 as i32 + 2 as i32)
            as crate::jdct_h::DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_7x7(
    ...
    while ctr < 7 as i32 {
        ...
        z1 = tmp0 + tmp2;
        *dataptr.offset(0 as i32 as isize) =
            ((z1 + tmp1 + tmp3 - (7 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32) as crate::jdct_h::DCTELEM;
        tmp3 += tmp3;
        z1 -= tmp3;
        z1 -= tmp3;
...
pub unsafe extern "C" fn jpeg_fdct_6x6(
    ...
    while ctr < 6 as i32 {
        ...
        tmp2 = (*elemptr.offset(2 as i32 as isize) as i32
            ...
            as crate::jmorecfg_h::INT32;
        *dataptr.offset(0 as i32 as isize) =
            ((tmp10 + tmp11 - (6 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32) as crate::jdct_h::DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_5x5(
    ...
    while ctr < 5 as i32 {
        ...
        tmp1 = (*elemptr.offset(1 as i32 as isize) as i32
            ...
            as crate::jmorecfg_h::INT32;
        *dataptr.offset(0 as i32 as isize) =
            ((tmp10 + tmp2 - (5 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32 + 1 as i32) as crate::jdct_h::DCTELEM;
        tmp11 = tmp11
            * (0.790569415f64
                * ((1 as i32 as crate::jmorecfg_h::INT32) << 13 as i32)
                    as f64
...
pub unsafe extern "C" fn jpeg_fdct_4x4(
    ...
    while ctr < 4 as i32 {
        ...
        tmp11 = (*elemptr.offset(1 as i32 as isize) as i32
            ...
            as crate::jmorecfg_h::INT32;
        *dataptr.offset(0 as i32 as isize) =
            ((tmp0 + tmp1 - (4 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32 + 2 as i32) as crate::jdct_h::DCTELEM;
        *dataptr.offset(2 as i32 as isize) =
        ...
        tmp0 += (1 as i32 as crate::jmorecfg_h::INT32)
            << 13 as i32 - 2 as i32 - 3 as i32;
        *dataptr.offset(1 as i32 as isize) = (tmp0
            + tmp10 * 6270 as i32 as crate::jmorecfg_h::INT32
            >> 13 as i32 - 2 as i32 - 2 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset(3 as i32 as isize) = (tmp0
            - tmp11 * 15137 as i32 as crate::jmorecfg_h::INT32
            >> 13 as i32 - 2 as i32 - 2 as i32)
            as crate::jdct_h::DCTELEM;
        dataptr = dataptr.offset(8 as i32 as isize);
        ctr += 1
...
pub unsafe extern "C" fn jpeg_fdct_3x3(
    ...
    while ctr < 3 as i32 {
        ...
        tmp0 = (*elemptr.offset(0 as i32 as isize) as i32
            ...
            as crate::jmorecfg_h::INT32;
        tmp1 =
            *elemptr.offset(1 as i32 as isize) as i32 as crate::jmorecfg_h::INT32;
        tmp2 = (*elemptr.offset(0 as i32 as isize) as i32
            - *elemptr.offset(2 as i32 as isize) as i32)
            as crate::jmorecfg_h::INT32;
        *dataptr.offset(0 as i32 as isize) =
            ((tmp0 + tmp1 - (3 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32 + 2 as i32) as crate::jdct_h::DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_2x2(
    ...
    tmp0 = (*elemptr.offset(0 as i32 as isize) as i32
        + *elemptr.offset(1 as i32 as isize) as i32)
        as crate::jmorecfg_h::INT32;
    tmp1 = (*elemptr.offset(0 as i32 as isize) as i32
        - *elemptr.offset(1 as i32 as isize) as i32)
        as crate::jmorecfg_h::INT32;
    /* Row 1 */
    ...
    tmp2 = (*elemptr.offset(0 as i32 as isize) as i32
        + *elemptr.offset(1 as i32 as isize) as i32)
        as crate::jmorecfg_h::INT32;
    tmp3 = (*elemptr.offset(0 as i32 as isize) as i32
        - *elemptr.offset(1 as i32 as isize) as i32)
        as crate::jmorecfg_h::INT32;
    /* Pass 2: process columns.
    ...
    *data.offset((8 as i32 * 0 as i32) as isize) =
        ((tmp0 + tmp2 - (4 as i32 * 128 as i32) as libc::c_long)
...
pub unsafe extern "C" fn jpeg_fdct_1x1(
    ...
    /* Apply unsigned->signed conversion */
    *data.offset(0 as i32 as isize) = (*(*sample_data.offset(0 as i32 as isize))
...
pub unsafe extern "C" fn jpeg_fdct_9x9(
    ...
    loop {
        ...
        /* Apply unsigned->signed conversion */
        *dataptr.offset(0 as i32 as isize) =
            ((z1 + z2 - (9 as i32 * 128 as i32) as libc::c_long)
...
pub unsafe extern "C" fn jpeg_fdct_10x10(
    ...
    loop {
        ...
        /* Apply unsigned->signed conversion */
        *dataptr.offset(0 as i32 as isize) =
            ((tmp10 + tmp11 + tmp12 - (10 as i32 * 128 as i32) as libc::c_long)
        ...
        *dataptr.offset((8 as i32 * 4 as i32) as isize) =
            (z1 + z2
                + ((1 as i32 as crate::jmorecfg_h::INT32)
                    << 13 as i32 + 1 as i32 - 1 as i32)
                >> 13 as i32 + 1 as i32) as crate::jdct_h::DCTELEM;
        *dataptr.offset((8 as i32 * 6 as i32) as isize) = (z1 - z2
            + ((1 as i32 as crate::jmorecfg_h::INT32)
                << 13 as i32 + 1 as i32 - 1 as i32)
            >> 13 as i32 + 1 as i32)
            as crate::jdct_h::DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_15x15(
    ...
    loop {
        ...
        z3 = tmp2 + tmp7;
        /* Apply unsigned->signed conversion */
        *dataptr.offset(0 as i32 as isize) = (z1 + z2 + z3
            - (15 as i32 * 128 as i32) as libc::c_long)
...
pub unsafe extern "C" fn jpeg_fdct_16x8(
    ...
    while ctr >= 0 as i32 {
        ...
        *dataptr.offset((8 as i32 * 4 as i32) as isize) = (tmp10 - tmp11
            ...
            as crate::jdct_h::DCTELEM;
        z1 = (tmp12 + tmp13) * 4433 as i32 as crate::jmorecfg_h::INT32;
        *dataptr.offset((8 as i32 * 2 as i32) as isize) = (z1
            + tmp12 * 6270 as i32 as crate::jmorecfg_h::INT32
            + ((1 as i32 as crate::jmorecfg_h::INT32)
                << 13 as i32 + 2 as i32 + 1 as i32 - 1 as i32)
            >> 13 as i32 + 2 as i32 + 1 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset((8 as i32 * 6 as i32) as isize) = (z1
            - tmp13 * 15137 as i32 as crate::jmorecfg_h::INT32
            + ((1 as i32 as crate::jmorecfg_h::INT32)
                << 13 as i32 + 2 as i32 + 1 as i32 - 1 as i32)
            >> 13 as i32 + 2 as i32 + 1 as i32)
            as crate::jdct_h::DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_14x7(
    ...
    crate::stdlib::memset(
        &mut *data.offset((8 as i32 * 7 as i32) as isize)
...
pub unsafe extern "C" fn jpeg_fdct_12x6(
    ...
    crate::stdlib::memset(
        &mut *data.offset((8 as i32 * 6 as i32) as isize)
            as *mut crate::jdct_h::DCTELEM as *mut libc::c_void,
        0 as i32,
        (::std::mem::size_of::<crate::jdct_h::DCTELEM>() as libc::c_ulong)
            .wrapping_mul(8 as i32 as libc::c_ulong)
    ...
    while ctr < 6 as i32 {
        ...
        tmp5 = (*elemptr.offset(5 as i32 as isize) as i32
            ...
            as crate::jmorecfg_h::INT32;
        *dataptr.offset(0 as i32 as isize) =
            ((tmp10 + tmp11 + tmp12 - (12 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32) as crate::jdct_h::DCTELEM;
        *dataptr.offset(6 as i32 as isize) =
...
pub unsafe extern "C" fn jpeg_fdct_10x5(
    ...
    crate::stdlib::memset(
        &mut *data.offset((8 as i32 * 5 as i32) as isize)
            as *mut crate::jdct_h::DCTELEM as *mut libc::c_void,
        0 as i32,
        (::std::mem::size_of::<crate::jdct_h::DCTELEM>() as libc::c_ulong)
            .wrapping_mul(8 as i32 as libc::c_ulong)
...
pub unsafe extern "C" fn jpeg_fdct_8x4(
    ...
    crate::stdlib::memset(
        &mut *data.offset((8 as i32 * 4 as i32) as isize)
            as *mut crate::jdct_h::DCTELEM as *mut libc::c_void,
        0 as i32,
        (::std::mem::size_of::<crate::jdct_h::DCTELEM>() as libc::c_ulong)
            .wrapping_mul(8 as i32 as libc::c_ulong)
    ...
    while ctr < 4 as i32 {
        ...
        *dataptr.offset(2 as i32 as isize) = (z1
            ...
            >> 13 as i32 - 2 as i32 - 1 as i32)
            as crate::jdct_h::DCTELEM;
        *dataptr.offset(6 as i32 as isize) = (z1
            - tmp13 * 15137 as i32 as crate::jmorecfg_h::INT32
            >> 13 as i32 - 2 as i32 - 1 as i32)
            as crate::jdct_h::DCTELEM;
        tmp10 = tmp0 + tmp3;
        ...
        *dataptr.offset(4 as i32 as isize) = ((tmp10 - tmp11 - tmp11)
        ...
        tmp10 = (tmp0 + tmp2)
            * (0.366025404f64
            ...
            >> 13 as i32 - 2 as i32 - 1 as i32;
        *dataptr.offset(1 as i32 as isize) = (tmp10
            + (tmp0 + tmp1 << 2 as i32 + 1 as i32))
            as crate::jdct_h::DCTELEM;
        *dataptr.offset(3 as i32 as isize) =
            (tmp0 - tmp1 - tmp2 << 2 as i32 + 1 as i32) as crate::jdct_h::DCTELEM;
        *dataptr.offset(5 as i32 as isize) = (tmp10
            + (tmp2 - tmp1 << 2 as i32 + 1 as i32))
            as crate::jdct_h::DCTELEM;
        dataptr = dataptr.offset(8 as i32 as isize);
        ctr += 1
    }
...
pub unsafe extern "C" fn jpeg_fdct_4x2(
    ...
    while ctr < 2 as i32 {
        ...
        *dataptr.offset(0 as i32 as isize) =
            ((tmp0 + tmp1 - (4 as i32 * 128 as i32) as libc::c_long)
                << 2 as i32 + 3 as i32) as crate::jdct_h::DCTELEM;
        *dataptr.offset(2 as i32 as isize) =
            (tmp0 - tmp1 << 2 as i32 + 3 as i32) as crate::jdct_h::DCTELEM;
        tmp0 = (tmp10 + tmp11) * 4433 as i32 as crate::jmorecfg_h::INT32;
        tmp0 += (1 as i32 as crate::jmorecfg_h::INT32)
            << 13 as i32 - 2 as i32 - 4 as i32;
        *dataptr.offset(1 as i32 as isize) = (tmp0
            + tmp10 * 6270 as i32 as crate::jmorecfg_h::INT32
            >> 13 as i32 - 2 as i32 - 3 as i32)
            as crate::jdct_h::DCTELEM;
...
pub unsafe extern "C" fn jpeg_fdct_2x1(
    ...
    *data.offset(0 as i32 as isize) =
        ((tmp0 + tmp1 - (2 as i32 * 128 as i32) as libc::c_long)
...
pub unsafe extern "C" fn jpeg_fdct_2x4(
    ...
    while ctr < 4 as i32 {
        ...
        /* advance pointer to next row */
        tmp0 =
            *elemptr.offset(0 as i32 as isize) as i32 as crate::jmorecfg_h::INT32;
        tmp1 =
            *elemptr.offset(1 as i32 as isize) as i32 as crate::jmorecfg_h::INT32;
        *dataptr.offset(0 as i32 as isize) =
            ((tmp0 + tmp1 - (2 as i32 * 128 as i32) as libc::c_long)
        ...
        *dataptr.offset(1 as i32 as isize) =
            (tmp0 - tmp1 << 3 as i32) as crate::jdct_h::DCTELEM;
        dataptr = dataptr.offset(8 as i32 as isize);
        ctr += 1
    }
    /* Even part */
...
pub unsafe extern "C" fn jpeg_fdct_1x2(
    ...
    tmp0 = *(*sample_data.offset(0 as i32 as isize)).offset(start_col as isize)
        as i32 as crate::jmorecfg_h::INT32;
    tmp1 = *(*sample_data.offset(1 as i32 as isize)).offset(start_col as isize)
        as i32 as crate::jmorecfg_h::INT32;
    /* We leave the results scaled up by an overall factor of 8.
