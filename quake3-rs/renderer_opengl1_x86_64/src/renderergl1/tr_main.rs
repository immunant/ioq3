...
pub static mut tr: trGlobals_t = trGlobals_t {
    ...
    dlightImage: std::ptr::null_mut(),
    flareImage: std::ptr::null_mut(),
    whiteImage: std::ptr::null_mut(),
    identityLightImage: std::ptr::null_mut(),
    defaultShader: std::ptr::null_mut(),
    shadowShader: std::ptr::null_mut(),
    projectionShadowShader: std::ptr::null_mut(),
    flareShader: std::ptr::null_mut(),
    sunShader: std::ptr::null_mut(),
    numLightmaps: 0,
    lightmaps: std::ptr::null_mut(),
    ...
    frontEndMsec: 0,
    models: [std::ptr::null_mut(); 1024],
    numModels: 0,
    numImages: 0,
    images: [std::ptr::null_mut(); 2048],
    numShaders: 0,
    shaders: [std::ptr::null_mut(); 16384],
    sortedShaders: [std::ptr::null_mut(); 16384],
    numSkins: 0,
    skins: [std::ptr::null_mut(); 1024],
    sinTable: [0.; 1024],
    squareTable: [0.; 1024],
