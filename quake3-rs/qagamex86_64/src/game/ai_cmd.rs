...
pub unsafe extern "C" fn BotMatch_HelpAccompany(
    ...
    if (*bs).teamgoal.entitynum < 0 as i32 {
        ...
        client = crate::src::game::ai_dmq3::ClientFromName(netname.as_mut_ptr());
        crate::src::game::g_syscalls::trap_BotEnterChat((*bs).cs, client, 1 as i32);
        return;
    }
    //the team mate
    (*bs).teammate = client;
...
pub unsafe extern "C" fn BotMatch_Camp(
    ...
    if client < 0 as i32 {
        ...
        crate::src::game::g_syscalls::trap_BotEnterChat((*bs).cs, (*bs).client, 1 as i32);
        return;
    }
    //get the match variable
    crate::src::game::g_syscalls::trap_BotMatchVariable(
...
pub unsafe extern "C" fn BotMatch_TaskPreference(
    ...
    crate::src::game::g_syscalls::trap_BotEnterChat((*bs).cs, teammate, 2 as i32);
...
pub unsafe extern "C" fn BotMatch_CheckPoint(
    ...
    position[2 as i32 as usize] = 0 as i32 as crate::src::qcommon::q_shared::vec_t;
...
pub unsafe extern "C" fn BotMatchMessage(
    ...
    if crate::src::game::g_syscalls::trap_BotFindMatch(
        ...
        (2 as i32 | 4 as i32 | 256 as i32) as libc::c_ulong,
    ) == 0
    {
        return crate::src::qcommon::q_shared::qfalse as i32;
    }
